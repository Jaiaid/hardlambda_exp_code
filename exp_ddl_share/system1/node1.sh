...
# numa node 0
time numactl --cpunodebind=0 --membind=0 python3 $ROOT_DIR/main.py -bs 16 -e 10 -nc 1000 -n 2 -ddl -ip 10.21.12.239 --port 44144 -if eno2 -id 0 -ws 4 -m resnet18 -d imagenet -s distributed_random -gpu -sampler graddist &
# numa node 1
time numactl --cpunodebind=1 --membind=1 python3 $ROOT_DIR/main.py -bs 16 -e 10 -nc 1000 -n 2 -ddl -ip 10.21.12.239 --port 44144 -if eno2 -id 1 -ws 4 -m resnet18 -d imagenet -s distributed_random -gpu -sampler graddist &
