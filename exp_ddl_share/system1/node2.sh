...
# numa node 0
time numactl --cpunodebind=0 --membind=0 python3 $ROOT_DIR/main.py -bs 16 -e $EPOCH -nc 1000 -n 2 -gpu -ddl -ip 10.21.12.239 --port 44144 -if eno4 -id 2 -ws 4 -m resnet18 -d imagenet -s distributed_random -sampler $SAMPLER  -ipm 127.0.0.1 -portm 50524 &
# numa node 1
time numactl --cpunodebind=1 --membind=1  python3 $ROOT_DIR/main.py -bs 16 -e $EPOCH -nc 1000 -n 2 -gpu -ddl -ip 10.21.12.239 --port 44144 -if eno4 -id 3 -ws 4 -m resnet18 -d imagenet -s distributed_random -sampler $SAMPLER -ipm 127.0.0.1 -portm 50525  &
