...
python3 $ROOT_DIR/data_provider_redis.py -data imagenet -root /sandbox1/data/imagenet/2017/ -size $CACHE_SIZE -offset $CACHE_SIZE -conf $ROOT_DIR/system1/redis3.conf -p 26380 &