...
from datatrain.dataset import SharedDistRedisPool, DatasetPipeline, GraddistBGPipeline
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.sampler == "shade":
        ...
        data_mover_service = subprocess.Popen(
            ...
            -bs 16 -cn 10.21.12.241 26379 10.21.12.241 26380 10.21.12.222 26379 -pn 10.21.12.241 10.21.12.222 -p {1}""".format(
