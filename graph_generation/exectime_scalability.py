...
if __name__=="__main__":
        ...
        for line in fin.readlines():
            ...
            if sampler == "default":
                if network_name == "mobilenet_v2":
                    data_dict[sampler][bs][dim][4] = exec_time
                elif network_name == "resnet18":
                    data_dict[sampler][bs][dim][5] = exec_time
                elif network_name == "resnet50":
                    data_dict[sampler][bs][dim][6] = exec_time
                elif network_name == "resnet101":
                    data_dict[sampler][bs][dim][7] = exec_time

            if network_name == "mobilenet_v2":
                data_dict[sampler][bs][dim][0] = exec_time
            elif network_name == "resnet18":
                data_dict[sampler][bs][dim][1] = exec_time
            elif network_name == "resnet50":
                data_dict[sampler][bs][dim][2] = exec_time
            elif network_name == "resnet101":
                data_dict[sampler][bs][dim][3] = exec_time
    ...
    with open(args.input) as fin:
        for line in fin.readlines():
            ...
            if network_name == "mobilenet_v2":
                data_dict[sampler][bs][dim][0] = data_dict["default"][bs][dim][4]/exec_time
            elif network_name == "resnet18":
                data_dict[sampler][bs][dim][1] = data_dict["default"][bs][dim][5]/exec_time
            elif network_name == "resnet50":
                data_dict[sampler][bs][dim][2] = data_dict["default"][bs][dim][6]/exec_time
            elif network_name == "resnet101":
                data_dict[sampler][bs][dim][3] = data_dict["default"][bs][dim][7]/exec_time
