...
if __name__=="__main__":
    ...
    for subfolder in COMPARED_LABELS_DICT:
        ...
        with open(filepath) as fin:
            for line in fin.readlines():
                ...
                if network_name == "mobilenet_v2":
                    data_dict[worker_count_key][sampler][bs][dim][0] = dl_time
                elif network_name == "resnet18":
                    data_dict[worker_count_key][sampler][bs][dim][1] = dl_time
                elif network_name == "resnet50":
                    data_dict[worker_count_key][sampler][bs][dim][2] = dl_time
                elif network_name == "resnet101":
                    data_dict[worker_count_key][sampler][bs][dim][3] = dl_time
        ...
        with open(filepath) as fin:
            for line in fin.readlines():
                ...
                if sampler == "graddistbg":
                    if network_name == "mobilenet_v2":
                        data_dict[worker_count_key][sampler][bs][dim][0] = data_dict["4worker"]["default"][bs][dim][0]/dl_time
                    elif network_name == "resnet18":
                        data_dict[worker_count_key][sampler][bs][dim][1] = data_dict["4worker"]["default"][bs][dim][0]/dl_time
                    elif network_name == "resnet50":
                        data_dict[worker_count_key][sampler][bs][dim][2] = data_dict["4worker"]["default"][bs][dim][0]/dl_time
                    elif network_name == "resnet101":
                        data_dict[worker_count_key][sampler][bs][dim][3] = data_dict["4worker"]["default"][bs][dim][0]/dl_time
    ...
    fig.savefig("fig_dl_scalability.pdf", format="pdf", bbox_inches="tight")
