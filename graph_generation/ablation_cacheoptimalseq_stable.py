...
hatchlist = ['o', 'x']
DISABLED_PATH = "ablation_data/benchmark_iteration_optimalchain_disabled_step.tsv"
...
if __name__=="__main__":
    ...
    fig.savefig("fig_ablation_cacheseq_clean.png", dpi=600, bbox_inches="tight")
    fig.savefig("fig_ablation_cacheseq_clean.pdf", format="pdf", bbox_inches="tight")
