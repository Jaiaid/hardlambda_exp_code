...
hatchlist = ['o', 'x']
DISABLED_PATH = "ablation_data/benchmark_iteration_bgmove_disabled_step.tsv"
...
if __name__=="__main__":
    ...
    ax.bar(np.arange(0, len(NETWORK_NAMES_LABEL_DICT)) + bias, datalist,
            label="BG Move Disabled", width=width, hatch=hatchlist[1])
    ...
    fig.savefig("fig_ablation_bgmove.png", dpi=600, bbox_inches="tight")
    fig.savefig("fig_ablation_bgmove.pdf", format="pdf", bbox_inches="tight")
